...
Route::group(['middleware' => ['web','not_installed'], 'namespace' => 'Snaptec\Cashier\Controllers'], function () {
    // direct
...
Route::group(['middleware' => ['web', 'not_installed', 'auth', 'backend'], 'namespace' => 'Snaptec\Cashier\Controllers'], function () {
    // direct
