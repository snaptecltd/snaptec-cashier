...
namespace Snaptec\Cashier\Services;

use Snaptec\Library\Contracts\PaymentGatewayInterface;
use Snaptec\Cashier\Cashier;
use Carbon\Carbon;
use Snaptec\Model\Invoice;
use Snaptec\Library\TransactionResult;
use Snaptec\Model\Transaction;
...
class BraintreePaymentGateway implements PaymentGatewayInterface
{
    ...
    {
        return action("\Snaptec\Cashier\Controllers\BraintreeController@settings");
    }
    ...
    public function autoCharge($invoice)
    {
        $invoice->checkout($this, function($invoice) {
            ...
            try {
                ...
                $authPaymentLink = action("\Snaptec\Cashier\Controllers\BraintreeController@checkout", [
    ...
    {
        return \Snaptec\Cashier\Cashier::lr_action("\Snaptec\Cashier\Controllers\BraintreeController@checkout", [
            'invoice_uid' => $invoice->uid,
        ]);
    }
    ...
    {
        return \Snaptec\Cashier\Cashier::lr_action("\Snaptec\Cashier\Controllers\BraintreeController@autoBillingDataUpdate", [
