...
class StripePaymentGateway implements PaymentGatewayInterface
{
    ...
    {
        return action("\Snaptec\Cashier\Controllers\StripeController@settings");
    }

    public function getAutoBillingDataUpdateUrl($returnUrl='/') : string
    {
        return \Snaptec\Cashier\Cashier::lr_action("\Snaptec\Cashier\Controllers\StripeController@autoBillingDataUpdate", [
    ...
    public function autoCharge($invoice)
    {
        $invoice->checkout($this, function($invoice) {
            try {
                ...
                $authPaymentLink = action("\Snaptec\Cashier\Controllers\StripeController@paymentAuth", [
    ...
    {
        return action("\Snaptec\Cashier\Controllers\StripeController@checkout", [
            'invoice_uid' => $invoice->uid,
        ]);
    }
