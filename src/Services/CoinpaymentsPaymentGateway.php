...
use Snaptec\Cashier\Library\CoinPayment\CoinpaymentsAPI;
...
class CoinpaymentsPaymentGateway implements PaymentGatewayInterface
{
    ...
    {
        return action("\Snaptec\Cashier\Controllers\CoinpaymentsController@settings");
    }

    public function getCheckoutUrl($invoice) : string
    {
        return action("\Snaptec\Cashier\Controllers\CoinpaymentsController@checkout", [
