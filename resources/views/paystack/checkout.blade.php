<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ \Snaptec\Cashier\Cashier::public_url('/vendor/snaptec-cashier/css/main.css') }}">
    </head>
    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Snaptec\Cashier\Cashier::public_url('/vendor/snaptec-cashier/image/paystack.svg') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">  
                ...
                <form id="checkoutForm" method="POST" action="{{ \Snaptec\Cashier\Cashier::lr_action('\Snaptec\Cashier\Controllers\PaystackController@checkout', [
