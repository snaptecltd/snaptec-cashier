    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Snaptec\Cashier\Cashier::public_url('/vendor/snaptec-cashier/image/razorpay.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">                
                ...
                <div class="hide" style="display:none">
                    <form action="{{ \Snaptec\Cashier\Cashier::lr_action('\Snaptec\Cashier\Controllers\RazorpayController@checkout', [
                    '_token' => csrf_token(),
